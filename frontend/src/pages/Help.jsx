...
const PAGE_CSS = `
  ...
  .step-card { background:rgba(255,255,255,.6); border:2px solid rgba(255,255,255,.85); border-radius:20px; padding:24px 18px; text-align:center; box-shadow:0 4px 14px rgba(0,0,0,.06); transition:transform .2s,box-shadow .2s; position:relative; overflow:hidden; }
  ...
  .faq-item { background:rgba(255,255,255,.6); border:2px solid rgba(255,255,255,.85); border-radius:18px; margin-bottom:10px; overflow:hidden; box-shadow:0 3px 12px rgba(0,0,0,.06); transition:box-shadow .2s; }
  .faq-item.open { box-shadow:0 6px 22px rgba(0,172,193,.12); border-color:rgba(128,222,234,.6); }
  .faq-q { width:100%; padding:18px 20px; background:none; border:none; cursor:pointer; display:flex; align-items:center; justify-content:space-between; gap:12px; font-family:'Poppins',sans-serif; text-align:left; }
  ...
  .faq-a { padding:14px 20px 18px; font-size:.84rem; color:#4a6070; line-height:1.75; border-top:1.5px solid rgba(128,222,234,.25); animation:expand .3s ease; }
  ...
  .sup-card { background:rgba(255,255,255,.6); border:2px solid rgba(255,255,255,.85); border-radius:18px; padding:22px 18px; text-align:center; box-shadow:0 4px 14px rgba(0,0,0,.06); transition:transform .2s; position:relative; overflow:hidden; }
