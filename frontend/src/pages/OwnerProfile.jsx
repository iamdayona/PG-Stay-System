        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="p-6 bg-white border border-gray-300">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl mb-1 text-gray-800">Rajesh Kumar</h3>
          ...
          <Card className="md:col-span-2 p-6 bg-white border border-gray-300">
            ...
            <div className="space-y-4 mb-8">
              <div className="grid grid-cols-3 gap-4">
                ...
                <span className="col-span-2 text-gray-800">Rajesh Kumar</span>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <span className="text-gray-600">Email:</span>
                <span className="col-span-2 text-gray-800">rajesh.kumar@example.com</span>
              </div>
              <div className="grid grid-cols-3 gap-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <span className="text-gray-600">Total PGs:</span>
                <span className="col-span-2 text-gray-800">2</span>
              </div>
            </div>
